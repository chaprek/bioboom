...
$_['error_firstname']      = 'Имя должно содержать не менее 3-х букв!';
$_['error_lastname']       = 'Фамилия должна содержать от 1 до 32 символов!';
$_['error_email']          = 'Не верный формат е-mail!';
$_['error_telephone']      = 'В телефоне должно быть от 3 до 32 цифр!';
$_['error_password']       = 'Пароль должен быть не менее 4-х символов!';
$_['error_confirm']        = 'Пароли не совпадают!';
$_['error_company_id']     = 'Введите ID компании!';
...
$_['error_user_exist']     = 'Пользователь с таким email уже существует';
?>