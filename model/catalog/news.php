...
class ModelCatalogNews extends Model { 
	...
	public function getNews($cat = false) {
	   
       if($cat){
         $and = " AND n.category_id=".$cat;
       } else {
        $and = "";
       }
	...
	public function getNewsShorts($limit) {
   	...
   	public function getNewsCats() { 
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "news_category WHERE lang_id = '" . (int)$this->config->get('config_language_id') . "'");
