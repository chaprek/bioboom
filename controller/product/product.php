...
class ControllerProductProduct extends Controller {
	...
	public function review() {
        ...
        /*-REVIEW-*/
            ...
            if(!isset($this->request->get['all_review'])){
                echo '<div class="pagination" style="text-align: center;">'.((isset($this->request->get['all_review']))?"":$this->data['pagination'] ).'<a href="'.$this->data['all_review'].'" class="all_review">Все комментарии</a></div>';
            }
           
           //'.(isset($this->request->get['all_review']))?"":$this->data['pagination'] . '<a href="'.$this->data['all_review'].'" class="all_review">Р’СЃРµ РѕС‚Р·С‹РІС‹</a>
	}
