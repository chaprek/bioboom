...
class ControllerModuleCart extends Controller {
	public function index() {
		...
		$this->data['text_items'] = sprintf($this->language->get('text_items'), $this->currency->format($total), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0) );
